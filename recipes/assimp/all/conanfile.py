...
class Assimp(ConanFile):
    ...
    def requirements(self):
        ...
        # - Open3DGC
        # - openddlparser
        self.requires(self.conan_data["dependencies"][self.version]["irrxml"])
        self.requires(self.conan_data["dependencies"][self.version]["minizip"])
        self.requires(self.conan_data["dependencies"][self.version]["utfcpp"])
